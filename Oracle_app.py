...
if selected_part == "Baseplate, Pump":
    ...
    type_options  = [
        "ANGULAR_CONTACT_BEARING", "BALL_BEARING", "ROLLER_BEARING",
        "TAPERED_BEARING", "ANTIFRICTION_THRUST_BEARING", "OTHER"
    ]
    ...
    if st.button("Genera Output", key="gen_bolt"):
        ...
        st.session_state["output_data"] = {
            "Item":               "...",             # inserisci codice Item
            "Description":        descr_bolt,
            "Identificativo":     "...",             # inserisci Identificativo
            "Classe ricambi":     "...",             # inserisci Classe ricambi
            "Categories":         "...",             # es. "FASCIA ITE 5"
            "Material":           materiale_bolt,
            "FPD material code":  codice_fpd_bolt,
            "Template":           "...",             # es. "FPD_BUY_2"
            "ERP_L1":             "...",             # es. "23_BOLT_HARDWARE"
            "ERP_L2":             "...",             # es. "12_EYE_BOLT"
            "To supplier":        "",
            "Quality":            ""
        }
